...
class NavigationMenuTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		NavigationMenu::create([
			...
			Tres municipios representan 50% del total de fallecimientos causados por tumores de tipo maligno; Guadalajara (29.7%), Zapopan (14.5%) y Tlaquepaque (5.8 por ciento). De aquí la gran 
			...
			aunque gradualmente serán atendidos otros tipos de cáncer. Estamos en una ubicación estratégica de la ciudad de Guadalajara con gran influencia en la zona, se ahí la importancia de contar 
			...
			dimensiones, pero sobre todo es necesario saber que si esta enfermedad se detecta a tiempo es curable. Pregunte por nuestros paquetes preferentes de detección oportuna “Porque me quiero 
			me cuido”',
